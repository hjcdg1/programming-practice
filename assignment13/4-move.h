        ...
        for(i=0; i<4; i++){
                ...
                for(j=0; j<4; j++){
					...
					score += curr->tile[i][j] + look(&left[i]);
                                        if(curr->tile[i][j] + look(&left[i]) == 8)      return -5;                                        
        ...
        for(i=0; i<4; i++){
                ...
                for(j=3; j>=0; j--){
					...
					score += curr->tile[i][j] + look(&right[i]);
                                        if(curr->tile[i][j] + look(&right[i]) == 8)     return -5;
        ...
        for(j=0; j<4; j++){
                ...
                for(i=0; i<4; i++){
					...
					score += curr->tile[i][j] + look(&up[j]);
                                        if(curr->tile[i][j] + look(&up[j]) == 8)        return -5;                                       
        ...
        for(j=0; j<4; j++){
                ...
                for(i=3; i>=0; i--){
					...
					score += curr->tile[i][j] + look(&down[j]);
                                        if(curr->tile[i][j] + look(&down[j]) == 8)      return -5;
